...
import kotlinLabSci.math.array.util.Function;
import kotlinLabSci.math.array.util.IndexFunction;
import kotlinLabSci.math.array.util.Random;
import kotlinLabSci.math.array.util.Sorting;
...
public static String toString(double [][]d) {
    return kotlinLabSci.math.array.Matrix.printArray(d);
}
        // print methods
...
return str.toString();
	 ...
	 * Must import kotlinLabSci.math.array.util.*; to get Function interface.
