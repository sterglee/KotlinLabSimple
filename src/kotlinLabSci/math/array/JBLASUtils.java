...
kotlinLabSci.math.array.Matrix.metaClass.multiply = { 
   kotlinLabSci.math.array.Matrix m ->   // the input Matrix
    ...
    kotlinLabSci.math.array.JBLASUtils.JBLASDoubleMatrixToDouble2D(mulRes)
}
