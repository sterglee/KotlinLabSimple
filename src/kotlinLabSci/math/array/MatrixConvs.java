...
public class MatrixConvs {
    ...
    // convert EJML DenseD2Matrix64F to Matrix
    public static Matrix EJML2Matrix(org.ejml.data.DenseD2Matrix64F  dm)     {
      int nr = dm.numRows;
      int nc = dm.numCols;
      Matrix rm = new Matrix(nr, nc);
      for (int r=0; r<nr; r++)
  ...
  // convert EJML  DenseD2Matrix64F to Double Array
    public static double[][] EJML2DoubleArray(org.ejml.data.DenseD2Matrix64F  dm)     {
      int nr = dm.numRows;
      int nc = dm.numCols;
      double [][] rm = new double[nr][nc];
      for (int r=0; r<nr; r++)
    ...
    // convert Matrix to EJML DenseD2Matrix64F
    public static org.ejml.data.DenseD2Matrix64F   Matrix2EJML(Matrix dm)     {
      int nr = dm.Nrows();
      int nc = dm.Ncols();
      org.ejml.data.DenseD2Matrix64F  rm = new org.ejml.data.DenseD2Matrix64F(nr, nc);
      for (int r=0; r<nr; r++)
          for (int c=0; c<nc; c++)
  ...
  //// convert double [][] to JBLAS DoubleMatrix 
    public static org.ejml.data.DenseD2Matrix64F  DoubleArray2EJML(double [][] dm)     {
      int nr = dm.length;
      int nc = dm[0].length;
      org.ejml.data.DenseD2Matrix64F  rm = new org.ejml.data.DenseD2Matrix64F(nr, nc);
      for (int r=0; r<nr; r++)
