...
import kotlinLabSci.math.plot.canvas.Plot2DCanvas;
import kotlinLabSci.math.plot.canvas.PlotCanvas;
import kotlinLabSci.math.plot.components.LegendPanel;
import kotlinLabSci.math.plot.components.PlotToolBar;
   ...
   /*   these methods allow the handling of axis by retrieving first a PlotPanel reference.
    t = inc(0, 0.01, 20);
        ...
        public void xlabel(String xLabelStr) {
            setAxisLabel(kotlinLabSci.math.plot.PlotPanel.xAxisId, xLabelStr);
        }
        
        public void ylabel(String yLabelStr) {
            setAxisLabel(kotlinLabSci.math.plot.PlotPanel.yAxisId, yLabelStr);
        }
        
        public void zlabel(String zLabelStr) {
            if (this instanceof  Plot3DPanel) {
               setAxisLabel(kotlinLabSci.math.plot.PlotPanel.zAxisId, zLabelStr);
            }
        }
