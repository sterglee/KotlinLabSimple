...
import kotlinLabSci.math.plot.MatrixTablePanel;
import java.awt.*;
...
public class DatasFrame extends JFrame {
    ...
    // add a tab for each plot object
        for (kotlinLabSci.math.plot.plots.Plot plot: plotCanvas.getPlots())
    ...
    public class DataPanel extends JPanel {
        ...
        kotlinLabSci.math.plot.plots.Plot plot;
        DatasFrame dframe;

        public DataPanel(kotlinLabSci.math.plot.plots.Plot _plot) {
            plot = _plot;
