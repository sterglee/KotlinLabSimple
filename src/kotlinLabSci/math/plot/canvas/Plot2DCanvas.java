package kotlinLabSci.math.plot.canvas;

import kotlinLabSci.math.plot.render.AWTDrawer2D;
import kotlinLabSci.math.plot.plots.LinePlot;
import kotlinLabSci.math.plot.plots.scalogram;
import kotlinLabSci.math.plot.plots.MarksPlot;
import kotlinLabSci.math.plot.plots.RealTimePlot;
import kotlinLabSci.math.plot.plots.StaircasePlot;
import kotlinLabSci.math.plot.plots.contourPlot;
import kotlinLabSci.math.plot.plots.BoxPlot2D;
import kotlinLabSci.math.plot.plots.CloudPlot2D;
import kotlinLabSci.math.plot.plots.BarPlot;
import kotlinLabSci.math.plot.plots.ScatterPlot;
import kotlinLabSci.math.plot.plots.LineMarksPlot;
import kotlinLabSci.math.plot.plots.HistogramPlot2D;
import kotlinLabSci.math.plot.plotObjects.BasePlot;
import kotlinLabSci.math.plot.plotObjects.Base;
import java.awt.*;


import static kotlinLabSci.math.plot.plotObjects.Base.*;
import static kotlinLabSci.math.plot.utils.Histogram.*;
