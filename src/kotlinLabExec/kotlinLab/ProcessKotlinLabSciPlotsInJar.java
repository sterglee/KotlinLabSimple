...
public class ProcessKotlinLabSciPlotsInJar extends JFrame {
...
*/
   ...
   public ProcessKotlinLabSciPlotsInJar(String jarFile)
   {
      setTitle("kotlinLabSci Plots  Examples  ");
      ...
      examplesLabel.setText("Selected kotlinLabSci Plot example: ");
   ...
   {  
      ...
      {  
         ...
         {  
            ...
            if (nameOfEntry.endsWith(".plots-jsci") ) 
