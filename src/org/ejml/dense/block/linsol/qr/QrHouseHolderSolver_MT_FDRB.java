...
/**
 * <p>
 * A solver for {@link org.ejml.dense.block.decomposition.qr.QRDecompositionHouseholder_MT_FDRB}. Systems are solved for using the standard
...
public class QrHouseHolderSolver_MT_FDRB implements LinearSolverDense<FMatrixRBlock> {
    ...
    public void solve( FMatrixRBlock B, FMatrixRBlock X ) {
        ...
        TriangularSolver_MT_FDRB.solve(QR.blockLength, true,
