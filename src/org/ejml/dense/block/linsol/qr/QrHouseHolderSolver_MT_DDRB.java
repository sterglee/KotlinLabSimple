...
/**
 * <p>
 * A solver for {@link org.ejml.dense.block.decomposition.qr.QRDecompositionHouseholder_MT_DDRB}. Systems are solved for using the standard
...
public class QrHouseHolderSolver_MT_DDRB implements LinearSolverDense<DMatrixRBlock> {
    ...
    public void solve( DMatrixRBlock B, DMatrixRBlock X ) {
        ...
        TriangularSolver_MT_DDRB.solve(QR.blockLength, true,
