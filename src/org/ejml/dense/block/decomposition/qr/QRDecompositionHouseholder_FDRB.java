...
//CONCURRENT_MACRO BlockHouseHolder_FDRB BlockHouseHolder_MT_FDRB
...
public class QRDecompositionHouseholder_FDRB
    ...
    private final FSubmatrixD1 W = new FSubmatrixD1(dataW);
    private final FSubmatrixD1 WTA = new FSubmatrixD1(dataWTA);
     ...
     */
    public static FMatrixRBlock initializeQ( @Nullable FMatrixRBlock Q,
    ...
    public void applyQ( FMatrixRBlock B, boolean isIdentity ) {
        ...
        for (int i = start; i >= 0; i -= blockLength) {
            ...
            if (!saveW)
                BlockHouseHolder_FDRB.computeW_Column(blockLength, Y, W, workspace, gammas, Y.col0);
