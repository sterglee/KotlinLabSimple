 ...
 * @author Peter Abeles
 */
@Generated("org.ejml.dense.block.decomposition.qr.BlockHouseHolder_FDRB")
...
//                    for( int k = 0; k < height; k++ ) {
    ...
    public static void computeW_Column( final int blockLength,
                                        ...
                                        @Nullable GrowArray<FGrowArray> workspace, final float[] beta, int betaIndex ) {
        ...
        final float[] temp = workspace.grow().reshape(Y.col1 - Y.col0).data;
