...
//        System.out.printf("eigen (%6.3ff , %6.3ff) (%6.3ff , %6.3ff)\n",p0_real,p0_img,p1_real,p1_img);
    ...
    protected void rank1UpdateMultL( FMatrixRMaj A, float gamma, int colA0, int w0, int w1 ) {
        QrHelperFunctions_FDRM.rank1UpdateMultL(A, u.data, gamma, colA0, w0, w1);
    }

    protected void rank1UpdateMultR( FMatrixRMaj A, float gamma, int colA0, int w0, int w1 ) {
        QrHelperFunctions_FDRM.rank1UpdateMultR(A, u.data, gamma, colA0, w0, w1, _temp.data);
    }
