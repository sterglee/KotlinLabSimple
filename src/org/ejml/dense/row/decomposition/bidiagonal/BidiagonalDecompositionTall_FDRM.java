...
//CONCURRENT_INLINE import org.ejml.dense.row.CommonOps_MT_FDRM;;
...
public class BidiagonalDecompositionTall_FDRM
    ...
    //CONCURRENT_BELOW BidiagonalDecomposition_F32<FMatrixRMaj> decompBi = new BidiagonalDecompositionRow_MT_FDRM();
    ...
    public FMatrixRMaj getU( @Nullable FMatrixRMaj U, boolean transpose, boolean compact ) {
        ...
        if (compact) {
            ...
            //CONCURRENT_BELOW CommonOps_MT_FDRM.mult(Q1,U1,U);
            ...
            //CONCURRENT_BELOW CommonOps_MT_FDRM.mult(Q1,U1,tmp);
    ...
    public boolean decompose( FMatrixRMaj orig ) {
        ...
        //CONCURRENT_BELOW CommonOps_MT_FDRM.multTransB(B, P, result);
