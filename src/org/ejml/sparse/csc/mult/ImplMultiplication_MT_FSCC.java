...
public class ImplMultiplication_MT_FSCC {
    ...
    public static void mult( FMatrixSparseCSC A, FMatrixSparseCSC B, FMatrixSparseCSC C,
                             GrowArray<Workspace_MT_FSCC> listWork ) {
        ...
        EjmlConcurrency.loopBlocks(0, B.numCols, listWork, ( workspace, bj0, bj1 ) -> {
            ...
            float[] x = adjust(workspace.gx, A.numRows);
     ...
     */
    public static void stitchMatrix( FMatrixSparseCSC out, int numRows, int numCols,
                                     GrowArray<Workspace_MT_FSCC> listWork ) {
    ...
    public static void mult( FMatrixSparseCSC A, FMatrixRMaj B, FMatrixRMaj C, boolean add,
                             GrowArray<FGrowArray> listWork ) {
        // Break the problem up into blocks of columns and process them independently
        EjmlConcurrency.loopBlocks(0, B.numCols, listWork, ( gwork, bj0, bj1 ) -> {
            ...
            float[] work = gwork.reshape(A.numRows + B.numRows).data;
...
//                        C.data[ai*C.numCols + bj] += A.nz_values[i]*B.data[k*B.numCols + bj];
    ...
    public static void multTransA( FMatrixSparseCSC A, FMatrixRMaj B, FMatrixRMaj C,
        ...
        EjmlConcurrency.loopBlocks(0, B.numCols, listWork, ( gwork, j0, j1 ) -> {
            ...
            float[] work = gwork.reshape(B.numRows).data;
...
//                        sum += A.nz_values[indexA]*B.data[k*B.numCols + j];
    ...
    public static void multTransB( FMatrixSparseCSC A, FMatrixRMaj B, FMatrixRMaj C, boolean add,
                                   GrowArray<FGrowArray> listWork ) {
        // Break the problem up into blocks of columns and process them independently
        EjmlConcurrency.loopBlocks(0, B.numRows, listWork, ( gwork, bj0, bj1 ) -> {
            // Local copy of column in A to reduce cache misses
            float[] work = gwork.reshape(A.numRows).data;
