 ...
 * @author Peter Abeles
 */
@Generated("org.ejml.sparse.csc.misc.TriangularSolver_DSCC")
public class TriangularSolver_FSCC {
     ...
     */
    public static int searchNzRowsInX( FMatrixSparseCSC G, FMatrixSparseCSC B, int colB, @Nullable int[] pinv,
                                       int[] xi, int[] w ) {
